...
image:./images/Reference/rr-AnalyticalSpheres.png[pdfwidth=7in,align=left]

_A collection of colored spheres with neutral IBL._

.Colored Spheres with Cannon IBL
image:./images/Reference/rr-AnalyticalSpheres-Cannon.png[pdfwidth=7in,align=left]

_A collection of colored spheres with cannon IBL._

.Colored Spheres with Street IBL
image:./images/Reference/rr-AnalyticalSpheres-Street.png[pdfwidth=7in,align=left]

_A collection of colored spheres with street scene IBL._

.Colored Spheres with Studio IBL
image:./images/Reference/rr-AnalyticalSpheres-Studio.png[pdfwidth=7in,align=left]
...
image:./images/Reference/rr-AnalyticalCubes.png[pdfwidth=7in,align=left]
...
image:./images/Reference/rr-AnalyticalGrayscale.png[pdfwidth=7in,align=left]
...
.Mixer Full View
image:./images/Reference/rr-Mixer-0.png[pdfwidth=7in,align-left]
...
.Mixer Head
image:./images/Reference/rr-Mixer-1.png[pdfwidth=7in,align-left]

_Mixer model showing different metalic types. This is the view from camera1._

.Mixer Base
image:./images/Reference/rr-Mixer-2.png[pdfwidth=7in,align-left]
...
.Shoe Full View
image:./images/Reference/rr-Shoe-0.png[pdfwidth=7in,align-left]
...
image:./images/Reference/rr-Shoe-1.png[pdfwidth=7in,align-left]
...
image:./images/Reference/rr-Shoe-2.png[pdfwidth=7in,align-left]
...
image:./images/Reference/rr-WickerChair-0.png[pdfwidth=7in,align-left]
...
image:./images/Reference/rr-WickerChair-1.png[pdfwidth=7in,align-left]

_TBD (camera1)_

The correct transparency mode is BLEND which shows soft edges (above). The incorrect transparency mode is MASK which has abrupt hard edges (below).

The incorrect transparency mode Alpha Test, which has abrupt hard edges.

![](WARN_REPLACE_IMG_URL)
A closeup showing incorrect depth sorting (left) versus correct depth sorting (right). The larger curvy texture on the outside surface should render in front of the smaller texture on the inside surface.
...
image:./images/Reference/rr-WickerChair-2.png[pdfwidth=7in,align-left]
_TBD (camera2)_

Normal map on the red cushion shows correct tangent basis for the normal map. The wrinkles are rendered as indentations, and the wrinkles are shaded consistently across UV borders.

![](WARN_REPLACE_IMG_URL)

Normal map showing an incorrect tangent basis. The green channel of the normal map is being shaded incorrectly, causing abrupt shading changes where the wrinkles cross the UV seam.

![](WARN_REPLACE_IMG_URL)

Normal map showing a different incorrect tangent basis. The red channel of the normal map is shading incorrectly, causing abrupt shading changes across the UV seam (lower circles) and the wrinkles to look like hills rather than valleys (upper circle).

[[tennis-racquet]]
== Tennis Racquet

https://gitlab.khronos.org/3dcommerce/certification-models/-/tree/master/TennisRacquet[Model]

.Tennis Racquet Full View
image:./images/Reference/rr-TennisRacquet-0.png[pdfwidth=7in,align-left]
...
image:./images/Reference/rr-TennisRacquet-1.png[pdfwidth=7in,align-left]
...
image:./images/Reference/rr-TennisRacquet-2.png[pdfwidth=7in,align-left]
...
[[green-chair]]
== Green Chair
*Asset re-uploaded with more cameras, awaiting merge in gitlab.*
...
image:./images/Reference/rr-GreenChair-0.png[pdfwidth=7in,align-left]
...
image:./images/Reference/rr-GreenChair-1.png[pdfwidth=7in,align-left]
...
.Green Chair Texture Transform
image:./images/Reference/rr-GreenChair-2.png[pdfwidth=7in,align-left]
