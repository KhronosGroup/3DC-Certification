...
*"Certificant"* is a company, regardless of whether that party is a Khronos Member, that has executed the https://docs.google.com/document/d/1cak3ZwXAxJQzph6BywWWHKGTx8_-9S9hfK2oHI-Uu2Q/edit#heading=h.tfdpnxkysq18[Khronos Certification Agreement _(location tdb)_] for the Program and has currently paid the Certification Program Fee.
...
The marks that may be used in association with a Certified Viewer under the terms of the Khronos Certification Agreement and the Khronos trademark guidelines available at [https://www.khronos.org/legal/trademarks/](https://www.khronos.org/legal/trademarks/) are:
